 ...
 */
public class AutowiringVaadinApplicationServlet extends GAEApplicationServlet {
     ...
     * 
     * <p>
     * The implementation in {@link AutowiringVaadinApplicationServlet} delegates to
    ...
    protected Application getNewApplication(HttpServletRequest request) throws ServletException {
        ...
        try {
            ...
            throw new ServletException("failed to create application", e);
        }
